...
subgraph Pipeline
  ...
  subgraph App_Lane
    ...
    subgraph App_Tests_PreBuild
      ...
      PTJ --> AT1[Lint App<br>- ESLint]
      PTJ --> AT2[Unit Test<br>- Jest]
    ...
    subgraph App_Build
      ...
      CBJ --> AB2[Build Container<br>- Docker<br>- Node 20]
      AB2 --> AB3[Vulnerability Scan<br>- Trivy<br>- Grype<br>- Syft]
      CBJ --> AB4[Build Serverless Package<br>- Webpack<br>- Bundler<br>- SST]
    ...
    subgraph App_Tests_PostBuild
      ...
      ITJ --> BIT[Backend Integration Tests<br>- Supertest<br>- Newman<br>- Testcontainers<br>- k6]
  ...
  %% ====================
  subgraph Deploy
    TG4 --> DP1[Deploy App<br>- K8s<br>- PM2]
    TG4 --> DP2[Deploy Serverless App<br>- AWS Lambda<br>- Azure Functions<br>- SST]
  end
