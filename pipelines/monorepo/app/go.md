...
subgraph Pipeline
  ...
  subgraph App_Lane
    ...
    subgraph App_Tests_PreBuild
      ...
      PTJ --> AT1[Lint App<br>- golangci-lint]
      PTJ --> AT2[Unit Test<br>- go test]
    ...
    subgraph App_Build
      ...
      CBJ --> AB2[Build Container<br>- Docker<br>- Go Binary]
      AB2 --> AB3[Vulnerability Scan<br>- Trivy<br>- Grype<br>- Syft]
      CBJ --> AB4[Build Serverless Package<br>- AWS SAM<br>- Go Binary]
    ...
    subgraph App_Tests_PostBuild
      ...
      ITJ --> BIT[Backend Integration Tests<br>- go test integration<br>- Postman Newman<br>- Testcontainers<br>- k6]
  ...
  %% ====================
  subgraph Deploy
    TG4 --> DP1[Deploy App<br>- K8s<br>- Binary]
