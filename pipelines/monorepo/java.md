...
subgraph Pipeline
  ...
  subgraph App_Lane
    ...
    subgraph App_Tests_PreBuild
      ...
      PTJ --> AT1[Lint App<br>- Checkstyle<br>- SpotBugs]
      PTJ --> AT2[Unit Test<br>- JUnit<br>- Mockito]
    ...
    subgraph App_Build
      ...
      CBJ --> AB2[Build Container<br>- Docker<br>- JAR/WAR Packaging]
      AB2 --> AB3[Vulnerability Scan<br>- Trivy<br>- Grype<br>- Syft]
      CBJ --> AB4[Build Serverless Package<br>- AWS SAM<br>- Quarkus<br>- Spring Boot Native]
    ...
    subgraph App_Tests_PostBuild
      ...
      ITJ --> BIT[Backend Integration Tests<br>- JUnit Integration<br>- Postman Newman<br>- Testcontainers<br>- k6]
  ...
  %% ====================
  subgraph Deploy
    TG4 --> DP1[Deploy App<br>- K8s<br>- JAR/WAR]
    TG4 --> DP2[Deploy Serverless App<br>- AWS Lambda<br>- AWS SAM<br>- Quarkus]
  end
